    ...
    <main className="min-h-screen bg-[#faf8f5]">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-start h-full pt-[12vh] px-4 text-center">
          ...
          <p className="tracking-[0.35em] text-[20px] uppercase text-[#6D071A ] font-light mb-1" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Invitation
          </p>
          <div className="w-16 h-px bg-[#6D071A ] opacity-60 mb-6" />
          <div className="animate-bounce mt-2">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M5 8l5 5 5-5" stroke="#6D071A " strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute bottom-[8vh] left-0 right-0 z-10 flex flex-col items-center px-4 text-center">
          <h1 className="text-5xl md:text-7xl text-[#2c2118] leading-none mb-3" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}>
            Erika <span className="text-[#6D071A ]">&</span> Audry
          </h1>
      ...
      <section className="py-20 px-4 bg-[#faf8f5]">
        <p className="text-center tracking-[0.3em] text-[20px] uppercase text-[#6D071A ] mb-10" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          Plus que…
        </p>
        ...
        <div className="flex items-center justify-center gap-4 mt-16 mb-0">
          <div className="h-px w-16 md:w-32 bg-[#6D071A ] opacity-40" />
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            <path d="M9 1l2 6h6l-5 4 2 6-5-4-5 4 2-6-5-4h6z" fill="#6D071A " opacity="0.6" />
          </svg>
          <div className="h-px w-16 md:w-32 bg-[#6D071A ] opacity-40" />
        </div>
      </section>
